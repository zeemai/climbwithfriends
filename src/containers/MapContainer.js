...
const uk_Coor = { lat: 52.3555, lng: 1.1743 };
...
class MapsContainer extends Component {
  ...
  apiHasLoaded = ((map, mapsApi) => {
    this.setState({
      ...
      map,
      mapsApi,
      ukLatLng: new mapsApi.LatLng(uk_Coor.lat, uk_Coor.lng),
  ...
  handleSearch = (() => {
    ...
    const placesRequest = {
      ...
      type: ['gym'], // List of types: https://developers.google.com/places/supported_types
      query: ['climbing'],
      rankBy: mapsApi.places.RankBy.DISTANCE, // Cannot be used with radius.
    };

    // First, search for climbing centers
    placesService.textSearch(placesRequest, ((response) => {
      ...
      for (let i = 0; i < responseLimit; i++) {
        ...
        if (iceCreamPlace.opening_hours) {
          openNow = iceCreamPlace.opening_hours.isOpen(); // e.g true/false
        }
        ...
        const directionRequest = {
          origin: markerLatLng,
          destination: address, // Address of climbing centers
          travelMode: 'DRIVING',
        }
  ...
  render() {
    const { constraints, mapsLoaded, ukLatLng, markers, searchResults } = this.state;
      ...
      <div className="w-100 d-flex py-4 flex-wrap justify-content-center">
                ...
                return (
                  <div key={key} className="mb-4">
                    <div className="d-flex mb-2">
                      ...
                      <MapAutoComplete className="col-4 mr-2"
        ...
        <section className="col-8 h-lg googlemap">
          <GoogleMapReact
            ...
            defaultZoom={6}
            defaultCenter={{ lat: uk_Coor.lat, lng: uk_Coor.lng }}
